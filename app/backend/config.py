...
REWARD_AGENT_PROVIDER = os.getenv("REWARD_AGENT_PROVIDER", "openai").lower()
REWARD_AGENT_MODEL = os.getenv("REWARD_AGENT_MODEL", "qwen-plus" if REWARD_AGENT_PROVIDER == "qwen" else AI_FILTER_MODEL)
REWARD_AGENT_MODEL_REQUIRED = os.getenv("REWARD_AGENT_MODEL_REQUIRED", "true").lower() == "true"
REWARD_AGENT_TIMEOUT_SECONDS = float(os.getenv("REWARD_AGENT_TIMEOUT_SECONDS", "30"))
REWARD_AGENT_ALLOW_BASELINE_FALLBACK = os.getenv("REWARD_AGENT_ALLOW_BASELINE_FALLBACK", "false").lower() == "true"
REWARD_AGENT_LANGSMITH_ENABLED = os.getenv("REWARD_AGENT_LANGSMITH_ENABLED", "false").lower() == "true"
REWARD_AGENT_BROWSER_ENABLED = os.getenv("REWARD_AGENT_BROWSER_ENABLED", "true").lower() == "true"
REWARD_AGENT_ALLOW_MOCK_DOCUMENTS = os.getenv("REWARD_AGENT_ALLOW_MOCK_DOCUMENTS", "false").lower() == "true"
...
API_HOST = "0.0.0.0"
API_PORT = 8000
ENABLE_REWARD_SCHEDULER = os.getenv("ENABLE_REWARD_SCHEDULER", "false").lower() == "true"
...
ANALYSIS_SCHEDULER_INTERVAL_MINUTES = _env_int("ANALYSIS_SCHEDULER_INTERVAL_MINUTES", 180)
...
APP_SCHEDULER_ENABLED = _env_flag("APP_SCHEDULER_ENABLED", "false")
AGENT_MEMORY_IMPORTANCE_THRESHOLD = float(os.getenv("AGENT_MEMORY_IMPORTANCE_THRESHOLD", "0.7"))
AGENT_MEMORY_RECALL_LIMIT = _env_int("AGENT_MEMORY_RECALL_LIMIT", 10)
AGENT_REFLECTION_RECALL_LIMIT = _env_int("AGENT_REFLECTION_RECALL_LIMIT", 10)

# Product-selection live adapter configuration
SELECTION_LIVE_FETCH_ENABLED = _env_flag("SELECTION_LIVE_FETCH_ENABLED", "false")
SELECTION_LIVE_FIRECRAWL_ENABLED = _env_flag("SELECTION_LIVE_FIRECRAWL_ENABLED", "true")
SELECTION_LIVE_HTTP_ENABLED = _env_flag("SELECTION_LIVE_HTTP_ENABLED", "true")
SELECTION_LIVE_MAX_ITEMS_PER_PLATFORM = _env_int("SELECTION_LIVE_MAX_ITEMS_PER_PLATFORM", 3)
SELECTION_LIVE_TIMEOUT_SECONDS = float(os.getenv("SELECTION_LIVE_TIMEOUT_SECONDS", "15"))
SELECTION_LIVE_TAOBAO_SEARCH_URL = os.getenv(
    "SELECTION_LIVE_TAOBAO_SEARCH_URL",
    "https://s.taobao.com/search?q={query}",
)
SELECTION_LIVE_XIANYU_SEARCH_URL = os.getenv(
    "SELECTION_LIVE_XIANYU_SEARCH_URL",
    "https://www.goofish.com/search?keyword={query}",
)
SELECTION_AUTOMATION_ENABLED = _env_flag("SELECTION_AUTOMATION_ENABLED", "false")
SELECTION_AUTOMATION_INTERVAL_MINUTES = _env_int("SELECTION_AUTOMATION_INTERVAL_MINUTES", 180)
SELECTION_AUTOMATION_MAX_QUERIES = _env_int("SELECTION_AUTOMATION_MAX_QUERIES", 5)
SELECTION_AUTOMATION_MAX_TRACKED_ITEMS = _env_int("SELECTION_AUTOMATION_MAX_TRACKED_ITEMS", 3)
SELECTION_AUTOMATION_MIN_OPPORTUNITY_SCORE = float(
    os.getenv("SELECTION_AUTOMATION_MIN_OPPORTUNITY_SCORE", "70")
)
SELECTION_AUTOMATION_MIN_CONFIDENCE_SCORE = float(
    os.getenv("SELECTION_AUTOMATION_MIN_CONFIDENCE_SCORE", "60")
)
SELECTION_OPERATIONS_ENABLED = _env_flag("SELECTION_OPERATIONS_ENABLED", "false")
SELECTION_OPERATIONS_INTERVAL_MINUTES = _env_int("SELECTION_OPERATIONS_INTERVAL_MINUTES", 240)
SELECTION_OPERATIONS_MAX_ITEMS = _env_int("SELECTION_OPERATIONS_MAX_ITEMS", 5)
SELECTION_OPERATIONS_STALE_HOURS = _env_int("SELECTION_OPERATIONS_STALE_HOURS", 48)
SELECTION_OPERATIONS_REMIND_AFTER_HOURS = _env_int("SELECTION_OPERATIONS_REMIND_AFTER_HOURS", 24)
