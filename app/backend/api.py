...
@app.get("/api/agent/sessions/{session_id}/insights")
...
@app.get("/api/agent/sessions/{session_id}/thinking")
...
@app.get("/api/agent/sessions/{session_id}/plans")
...
@app.get("/api/agent/sessions/{session_id}/memories")
...
@app.get("/api/agent/sessions/{session_id}/reflections")
...
@app.post("/api/product-selection/automation/runs")
...
@app.get("/api/product-selection/automation/runs")
...
@app.get("/api/product-selection/automation/runs/{job_id}")
...
@app.post("/api/product-selection/operations/runs")
...
@app.get("/api/product-selection/operations/runs")
...
@app.get("/api/product-selection/operations/runs/{job_id}")
